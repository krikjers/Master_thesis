classdef waypointGuidance_class    
    properties
    ...
    methods
        ...
        function [obj] = waypointGuidance_class(reference_psi_init, waypoints, vessel_position, Delta, beta, time_step, radius_of_acceptance)            
            obj.waypoints = waypoints;
            obj.current_waypoint = waypoints(1,:);
            obj.next_waypoint    = waypoints(2,:);
            obj.next_waypoint_index = 2; 
            obj.Delta = Delta;
            obj.beta = beta;
        ...
        function next_waypoint_index = getNextwaypointIndex(obj)
            next_waypoint_index = obj.next_waypoint_index;
        end
