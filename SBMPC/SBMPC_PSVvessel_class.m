classdef SBMPC_PSVvessel_class   
    ...
    methods
        function [obj] = SBMPC_PSVvessel_class(psvModelParameters, initial_eta, initial_nu, time_step, Kp_feedback_linearization, kp_heading, Xmax, Ymax, Nmax, K_sway, K_yaw, T_k_surge, T_k_sway, T_k_yaw)        
            %input psvModelParameters is found from PSVparameters.mat. It contains r_CG, m, M_RB, A_zero, T_i etc
            ...
            obj.Ymax = Ymax;
            obj.Nmax = Nmax;               
            obj.eta_initial = initial_eta;
            obj.nu_initial = initial_nu;
            obj.state_initial = [initial_eta;initial_nu];
            obj.state_dot_initial = [0;0;0;0;0;0];
            obj.eta = initial_eta;
            obj.nu = initial_nu;
        ...
        function obj = resetPSVState(obj)
           obj.eta = obj.eta_initial;
           obj.nu = obj.nu_initial;
           obj.state = obj.state_initial;
           obj.state_dot = obj.state_initial;
           obj.desired_psi = 0;
           obj.desired_nu = [0,0,0];
        end
        ...
        function [obj, tau] = updateStates(obj, desired_psi, desired_nu)
