scenario_name = 'ho_overtaken_cross_w_boundary_3_obs_2';
...
% obs 1
initial_obstacle_ship_states(:,1) = [1000;2800;-90*deg2rad;2;0;0]; %[x, y, psi, u, v, r
waypoints_obstacle_ships(:,:,1)   = [ 1000, 2800;    %obstacle ship 1 waypoints
                                      1000, -5000];
obs_speed_between_waypoints(1,:) =  [2];
changing_obs(1) = 0;
