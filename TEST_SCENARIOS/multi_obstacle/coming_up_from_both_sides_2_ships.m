scenario_name = 'coming_up_from_both_sides_2_ships';
...
% obs 1
initial_obstacle_ship_states(:,1) = [-2475;2475;-45*deg2rad;5;0;0]; %[x, y, psi, u, v, r]
waypoints_obstacle_ships(:,:,1)   = [ -2475, 2475;    %obstacle ship 1 waypoints
                                     5000,-5000];
...
% obs 2
initial_obstacle_ship_states(:,2) = [-2475;-2475;45*deg2rad;5;0;0];
waypoints_obstacle_ships(:,:,2)   = [-2475,-2475;    %obstacle ship 2 waypoints 
                                     5000,5000];    
