scenario_name = 'cross_3_sbmpc_obs';
...
% obs 1
initial_obstacle_ship_states(:,1) = [-1700;-42000;-90*deg2rad;0;0;0]; %[x, y, psi, u, v, r]
waypoints_obstacle_ships(:,:,1)   = [ -1700, -42000;    %obstacle ship 1 waypoints
                                      -1700, 5000];
obs_speed_between_waypoints(1,:) =  [0];
changing_obs(1) = 0;
