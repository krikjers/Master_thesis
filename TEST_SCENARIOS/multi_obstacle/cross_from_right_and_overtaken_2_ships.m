scenario_name = 'cross_from_right_and_overtaken_2_ships';

%% Own ship
eta_initial = [-1750;0;0];      %[x, y, psi (rad)]
nu_initial  = [2.5;0;0];          %[u,v,r]
initial_state = [eta_initial;nu_initial];
waypoints_own_ship = [ -1750,     0;
                      10000,   0]; 
...
waypoints_obstacle_ships(:,:,1)   = [0, 3500;
                                     0,-5000];
...
% obs 2
initial_obstacle_ship_states(:,2) = [-2500;500;0*deg2rad;5;0;0];
waypoints_obstacle_ships(:,:,2)   = [-2500, 500;    %obstacle ship 2 waypoints 
                                    5000, 500];    
