scenario_name = 'cross_from_left_and_changing_head_on_2_ships';
...
% obs 2
initial_obstacle_ship_states(:,2) = [2000;-800;-180*deg2rad;5;0;0];
waypoints_obstacle_ships(:,:,2)   = [2000,-800;    %obstacle ship 2 waypoints 
                                     1000,-800;
                                     -1000,1000];    
