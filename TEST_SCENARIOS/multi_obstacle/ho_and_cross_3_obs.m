scenario_name = 'ho_and_cross_3_obs';
...
% obs 2
initial_obstacle_ship_states(:,2) = [0;3500;-90*deg2rad;5;0;0];
waypoints_obstacle_ships(:,:,2)   = [0,3500;    %obstacle ship 2 waypoints 
                                     0,-5000;
                                     0,-5000;];    
...
% obs 3
initial_obstacle_ship_states(:,3) = [4500;1500;-180*deg2rad;5;0;0];
waypoints_obstacle_ships(:,:,3)   = [4500,1500;    %obstacle ship 2 waypoints 
                                    -5000,1500;
                                    -5000,1500];    
                               %WHEN DONE TESTING, FIRST WAYPOINT CAN BE SUBSTITUTED BY INITIAL OBS POSITION
...
% SBMPC obs 1
initial_SBMPC_obstacle_ship_states(:,1) = [9000;9000;-180*deg2rad;1;0;0]; %[x, y, psi, u, v, r]
waypoints_SBMPC_obstacle_ships(:,:,1) = [ 9000, 9000;   
                                          -8000, 9000;
                                          -8000, 9000];
