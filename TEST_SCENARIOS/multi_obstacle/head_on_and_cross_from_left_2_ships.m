scenario_name = 'head_on_and_cross_from_left_2_ships';

%% Own ship
eta_initial = [-4500;0;0];      %[x, y, psi (rad)]
...
waypoints_obstacle_ships(:,:,1)   = [ 2500, -0;    %obstacle ship 1 waypoints
                                     -9000,-0;
                                     -9000,-0;
                                     -9000,-0;
                                     -9000,-0];
...
% obs 2
initial_obstacle_ship_states(:,2) = [-1000;-3500;90*deg2rad;5;0;0];
waypoints_obstacle_ships(:,:,2)   = [-1000,-2500;    %obstacle ship 2 waypoints 
                                    -1000, -800;
                                    -2000, 0;
                                    -1000,1000;
                                    -1000,5000];    
                               %WHEN DONE TESTING, FIRST WAYPOINT CAN BE SUBSTITUTED BY INITIAL OBS POSITION
obs_speed_between_waypoints(2,:) =  [5,5,5,5];
changing_obs(2) = 1;
