scenario_name = 'mutli_cross_normal_obs_1';
...
% obs 1
initial_obstacle_ship_states(:,1) = [0; 6000;(-90)*deg2rad;5;0;0]; %[x, y, psi, u, v, r]
waypoints_obstacle_ships(:,:,1)   = [ 0,6000;    %obstacle ship 1 waypoints
                                      0,-5000;
                                      0,-5000];
...
% obs 2
initial_obstacle_ship_states(:,2) = [3500;0;(-180)*deg2rad;5;0;0];
waypoints_obstacle_ships(:,:,2)   = [3000, 0;    %obstacle ship 2 waypoints 
                                    -2000, 0;
                                    -2000, 0];    
...
% obs 3
initial_obstacle_ship_states(:,3) = [-300;5900; (-90)*deg2rad; 5;0;0];
waypoints_obstacle_ships(:,:,3)   = [-300,5900;    %obstacle ship 2 waypoints 
                                     -300,1500;           
                                    -3758, -2553];    
                               %WHEN DONE TESTING, FIRST WAYPOINT CAN BE SUBSTITUTED BY INITIAL OBS POSITION
obs_speed_between_waypoints(3,:) =  [5,5];
changing_obs(3) = 1;
