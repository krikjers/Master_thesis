scenario_name = 'plot_explanation';

%% Own ship
eta_initial = [-4000;-0;0*deg2rad];      %[x, y, psi (rad)]
...
% obs 1
initial_obstacle_ship_states(:,1) = [2000; 5250;(-90)*deg2rad;5;0;0]; %[x, y, psi, u, v, r]
waypoints_obstacle_ships(:,:,1)   = [ 2000,5250;    %obstacle ship 1 waypoints
                                      2000,-10000];
