scenario_name = 'head_on_2_ships_mixed';
...
% obs 1
initial_obstacle_ship_states(:,1) = [3500;1000;-180*deg2rad;5;0;0]; %[x, y, psi, u, v, r]
waypoints_obstacle_ships(:,:,1)   = [ 3500, 1000;    %obstacle ship 1 waypoints
                                      2000, 1000;
                                     -3000,-5000];
