scenario_name = 'cross_right_and_overtaken';

%% Own ship
eta_initial = [-2000;0;0];      %[x, y, psi (rad)]
nu_initial  = [2.5;0;0];          %[u,v,r]
initial_state = [eta_initial;nu_initial];
waypoints_own_ship = [ -2000,     0;
                      10000,   0]; 
...
% obs 1
initial_obstacle_ship_states(:,1) = [0;2000;-90*deg2rad;2.5;0;0]; %[x, y, psi, u, v, r]
waypoints_obstacle_ships(:,:,1)   = [ 0, 2000;    %obstacle ship 1 waypoints
                                     0, -5000;
                                    0,-5000];
obs_speed_between_waypoints(1,:) =  [2.5, 2.5];
changing_obs(1) = 0;
...
% obs 2
initial_obstacle_ship_states(:,2) = [-3500;500;0*deg2rad;5;0;0];
waypoints_obstacle_ships(:,:,2)   = [-3500,500;    %obstacle ship 2 waypoints 
                                    -2500,500;    
                                    3000,5000];    
...
% SBMPC obs 1
initial_SBMPC_obstacle_ship_states(:,1) = [-9000;-9000;0*deg2rad;5;0;0]; %[x, y, psi, u, v, r]
