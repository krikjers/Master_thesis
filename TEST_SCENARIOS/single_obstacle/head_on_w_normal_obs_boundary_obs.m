scenario_name = 'head_on_w_normal_obs_boundary_obs';
...
boundary_obstacles_params = [-800, 300, -800, 4000]; %[start_x, start_y, end_x, end_y]. One row for each obstacle!!
circle_obstacle_params    = [450, -800, 650];          %[radius, center_x, center_y].     One row for each obstacle!!