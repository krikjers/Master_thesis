scenario_name = 'overtaken_by_normal_obs';
...
% obs 1
initial_obstacle_ship_states(:,1) = [-3000;0;0*deg2rad;5;0;0]; %[x, y, psi, u, v, r]
waypoints_obstacle_ships(:,:,1)   = [ -3000, 0;    %obstacle ship 1 waypoints
                                      10000, 0];
...
% SBMPC obs 1
initial_SBMPC_obstacle_ship_states(:,1) = [-10000;-10000;0*deg2rad;5;0;0]; %[x, y, psi, u, v, r]
