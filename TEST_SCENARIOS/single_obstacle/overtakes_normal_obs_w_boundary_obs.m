scenario_name = 'overtakes_normal_obs_w_boundary_obs';
...
% obs 1
initial_obstacle_ship_states(:,1) = [0;0;0*deg2rad;0.5;0;0]; %[x, y, psi, u, v, r]
waypoints_obstacle_ships(:,:,1)   = [ 0, 0;    %obstacle ship 1 waypoints
                                      2000, 0];
obs_speed_between_waypoints(1,:) =  [0.5];
changing_obs(1) = 0;
...
boundary_obstacles_params = [-2800, 400, 2200, 400]; %[start_x, start_y, end_x, end_y]. One row for each obstacle!!
