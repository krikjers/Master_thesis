scenario_name = 'crossing_w_sbmpc_obs_on_right';

%% Own ship
eta_initial = [-3289;-1197;20*deg2rad];      %[x, y, psi (rad)]
nu_initial  = [5;0;0];          %[u,v,r]
initial_state = [eta_initial;nu_initial];
waypoints_own_ship = [ -3289,     -1197;
                      2349,   855]; 
...
% SBMPC obs 1
initial_SBMPC_obstacle_ship_states(:,1) = [-3289;1197;-20*deg2rad;5;0;0]; %[x, y, psi, u, v, r]
waypoints_SBMPC_obstacle_ships(:,:,1) = [ -3289, 1197;   %obstacle ship 1 waypoints [ 3000, 3000;   %obstacle ship 1 waypoints
                                         2349, -855];
