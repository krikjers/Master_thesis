scenario_name = 'crossing_w_sbmpc_obs_on_right_2';
...
% SBMPC obs 1
initial_SBMPC_obstacle_ship_states(:,1) = [-0;3500;-90*deg2rad;5;0;0]; %[x, y, psi, u, v, r]
waypoints_SBMPC_obstacle_ships(:,:,1) = [ -0, 3500;   %obstacle ship 1 waypoints [ 3000, 3000;   %obstacle ship 1 waypoints
                                         0, -9000];
...
circle_obstacle_params    = [350, 1500, 0];          %[radius, center_x, center_y].     One row for each obstacle!!