scenario_name = 'crossing_w_changing_normal_obs_on_right_2';
...
% obs 1
initial_obstacle_ship_states(:,1) = [0;3000;-90*deg2rad;4;0;0]; %[x, y, psi, u, v, r]
waypoints_obstacle_ships(:,:,1)   = [ 0,3000;    %obstacle ship 1 waypoints
                                      0, 2000;
                                    -3000,-5000];
obs_speed_between_waypoints(1,:) =  [4,4];
changing_obs(1) = 1;
...
% SBMPC obs 1
initial_SBMPC_obstacle_ship_states(:,1) = [5000;5000;-180*deg2rad;1;0;0]; %[x, y, psi, u, v, r]
