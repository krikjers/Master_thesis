scenario_name = 'head_on_w_circle_obs_and_intercepting_normal_obs';
...
% obs 1
initial_obstacle_ship_states(:,1) = [1500;800;-180*deg2rad;5;0;0]; %[x, y, psi, u, v, r]
waypoints_obstacle_ships(:,:,1)   = [ 1500,800;    %obstacle ship 1 waypoints
                                      -500, 800;
                                       -1000,0];
...
boundary_obstacles_params = [-3000, 400, 2000, 2000]; %[start_x, start_y, end_x, end_y]. One row for each obstacle!!
circle_obstacle_params    = [400, 0, 0];          %[radius, center_x, center_y].     One row for each obstacle!!